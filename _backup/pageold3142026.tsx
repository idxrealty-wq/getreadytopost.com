        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">
              Pick the plan that matches your workflow. All plans include MLS-safe, Fair Housing compliant rewrites.
            </p>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 md:p-10 shadow-sm">
            ...
            <div className="mt-8 text-center text-sm text-gray-600">
              Need help picking a plan? Start with <span className="font-semibold">One Credit</span> or <span className="font-semibold">Monthly</span>, then upgrade anytime.
            </div>
          </div>
        </div>
		      <section className="py-20 px-6 bg-white">
