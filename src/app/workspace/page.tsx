          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <iframe
                ...
                style={{ border: 0 }}
                loading="lazy"
                src={`https://www.google.com/maps/embed/v1/place?key=${mapKey}&q=${encodeURIComponent(address)}&zoom=17&maptype=satellite`}
              />
            </div>
              ...
              {[
                ...
                <div key={cat.label} className="bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/20">
                  ...
                  <iframe
                    ...
                    style={{ border: 0 }}
                    loading="lazy"
                    src={`https://www.google.com/maps/embed/v1/search?key=${mapKey}&q=${cat.query}+near+${encodeURIComponent(address)}&zoom=14&maptype=satellite`}
                  />
