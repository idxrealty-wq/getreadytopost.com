...
if (submitted) {
return (
<div className="min-h-screen bg-gradient-to-br from-[#1a2b4a] to-[#2d4a7c] flex items-center justify-center p-4"><div className="text-center"><h1 className="text-4xl font-bold text-white mb-4">Analysis Complete!</h1><p className="text-gray-300 mb-8">Redirecting to your report...</p></div></div>);
}


return (
<main className="pt-20 min-h-screen relative"><div className="fixed inset-0 z-0"><img
       src=" https://us.chat-img.sintra.ai/f3b53c23-1962-4de9-bee1-1ab563b224f9/1c6b6e83-767a-4a5f-9cc4-ea33a9ca148a/image.png?w=1200&h=896 "       alt="Background"
       className="w-full h-full object-cover" /><div className="absolute inset-0 bg-[#1a2b4a]/85"/></div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex justify-between mt-1">
            ...
            <p className={`text-sm font-bold ${wordCount < 50 ? "text-red-500" : wordCount < 140 ? "text-amber-500" : "text-green-500"}`}>
              {wordCount} words
            </p>
          </div>
        </div>
        ...
        <button onClick={handleSubmit} disabled={loading || !listingDescription || !email || !address} className="w-full bg-red-500 hover:bg-red-600 text-white py-4 rounded-xl font-bold text-lg transition disabled:opacity-50">
