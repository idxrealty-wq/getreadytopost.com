...
const personas = [
  {
    ...
    steps: [
      ...
      { number: '03', title: 'Receive Polished Copy', description: 'Get a fully rewritten, buyer-focused, MLS-compliant description. 140-160 words, ready to paste.', link: '/pricing', linkText: 'See Pricing', icon: '✏️' },
  ...
  },
  {
    ...
    emoji: '🏢',
    title: 'Broker / Team',
    subtitle: 'Elevate your entire team listing quality with consistent, compliant copy',
    ...
    steps: [
      ...
      { number: '03', title: 'Review and Approve', description: 'Each rewrite comes with a Quality Checklist showing exactly what was improved. One revision included per rewrite.', link: '/examples', linkText: 'See Examples', icon: '✅' },
  ...
  },
  {
    ...
    steps: [
      ...
      { number: '04', title: 'Post With Confidence', description: 'Use your polished description on Zillow, Realtor.com, Facebook Marketplace, or any FSBO platform. Stand out instantly.', link: '/examples', linkText: 'See Before and After', icon: '🎯' },
    ],
  },
  {
    id: 'homeowner',
    ...
    ctaLink: '/workspace',
    steps: [
      { number: '01', title: 'Complete Pre-Listing Questionnaire', description: 'Answer simple questions about your home best features, recent upgrades, neighborhood highlights, and lifestyle benefits.', link: '/workspace', linkText: 'Open Workspace', icon: '📋' },
...
export default function HowItWorksPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#1a2b4a] to-[#2d4a6f]">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {personas.map(p => {
              ...
              const activeClass = isActive ? 'bg-gradient-to-br ' + p.color + ' ' + p.border + ' scale-105 shadow-xl' : 'bg-white/5 border-white/20 hover:bg-white/10';
              return (
                <button
                  key={p.id}
                  onClick={() => setActivePersona(p.id)}
                  className={'rounded-2xl p-5 border-2 transition-all text-center ' + activeClass}
                >
      ...
      <section className="px-6 pb-16">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-3">Start Here. Level Up When You are Ready.</h2>
