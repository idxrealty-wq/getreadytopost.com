      ...
      <section className="px-6 pb-20">
        <div className="max-w-3xl mx-auto text-center bg-white/10 backdrop-blur-md rounded-3xl p-12 border border-white/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/rate-my-listing" className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-bold text-lg transition border border-white/20">Rate My Listing Free</Link>
          </div>
        </div>
      </section>
    </main>
