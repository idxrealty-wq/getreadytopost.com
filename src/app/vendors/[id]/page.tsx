...
if (loading) return (
<main className="min-h-screen bg-gray-950 pt-24 flex items-center justify-center"><p className="text-gray-400">Loading...</p></main>);


if (notFound || !vendor) return (
<main className="min-h-screen bg-gray-950 pt-24 flex items-center justify-center"><div className="text-center"><p className="text-4xl mb-4">🔍</p><h1 className="text-2xl font-bold text-white mb-2">Vendor Not Found</h1><p className="text-gray-400 mb-6">This vendor profile does not exist or is not active.</p><a href="/" className="text-yellow-500 hover:underline">Back to Home</a></div></main>);
...
return (
<main className="min-h-screen bg-gray-950 pt-24 pb-16 px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto"><div className="bg-gray-900 border border-gray-700 rounded-2xl overflow-hidden">
