  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-6">
        <ShareButtons url="https://getreadytopost.com/home-sellers" title="Grade Your Home Listing Free - GetReadyToPost" />
        <div className="text-center mb-16 mt-8">
          ...
          <Link href="/rate-my-listing" className="inline-block bg-[#c9a227] hover:bg-[#e8c547] text-[#1a2b4a] px-12 py-4 rounded-lg font-bold text-lg transition shadow-lg mb-8">
            Grade My Listing
          </Link>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 p-12 mb-12">
          <h2 className="text-3xl font-bold text-black mb-8 text-center">What You Will Get</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-black">See exactly what is working and what needs improvement in your listing copy.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="text-[#c9a227] text-2xl font-bold">✓</div>
