    ...
    <main className="min-h-screen bg-gradient-to-br from-[#1a2b4a] to-[#2d4a7c]">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6">Your Photos Get the Click.</h1>
          <p className="text-2xl text-gray-200 mb-8">Your Words Get the Showing.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/how-it-works" className="border-2 border-[#c9a227] text-[#c9a227] hover:bg-[#c9a227]/10 px-8 py-4 rounded-lg font-bold text-lg transition">See How It Works</Link>
          </div>
        </div>
      </section>
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">MLS Listing Descriptions That Sell</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">See How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">Why Agents Trust GetReadyToPost</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">Simple, Instant Pricing</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Write Better MLS Listings?</h2>
          <p className="text-xl text-gray-300 mb-8">Start with a free grade of your listing. See what buyers see. Get actionable feedback in seconds.</p>
