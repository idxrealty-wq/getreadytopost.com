    ...
    <main className="min-h-screen bg-gradient-to-br from-[#1a2b4a] to-[#2d4a7c]">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h1 className="text-6xl md:text-7xl font-bold text-gray-900 mb-6">Your Photos Get the Click.</h1>
          <p className="text-2xl text-gray-800 mb-8">Your Words Get the Showing.</p>
          <p className="text-lg text-gray-700 mb-12 max-w-2xl mx-auto">Most listing descriptions are invisible to buyers. Ours aren't. GetReadyToPost grades your listing across six critical categories and delivers a professional rewrite optimized for MLS, Fair Housing compliance, and buyer psychology.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/how-it-works" className="bg-[#c9a227] hover:bg-[#b8911f] text-gray-900 px-8 py-4 rounded-lg font-bold text-lg transition">See How It Works</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">MLS Listing Descriptions That Sell</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">See How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Paste Your Listing</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">AI Analysis & Rewrite</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Delivered Instantly</h3>
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Why Agents Trust GetReadyToPost</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              <div className="text-[#c9a227] text-3xl font-bold flex-shrink-0">✓</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">MLS Compliant</h3>
            ...
            <div className="flex gap-4">
              <div className="text-[#c9a227] text-3xl font-bold flex-shrink-0">✓</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Proven to Convert</h3>
            ...
            <div className="flex gap-4">
              <div className="text-[#c9a227] text-3xl font-bold flex-shrink-0">✓</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Broker Program Available</h3>
            ...
            <div className="flex gap-4">
              <div className="text-[#c9a227] text-3xl font-bold flex-shrink-0">✓</div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Works With Every MLS</h3>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Simple, Instant Pricing</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Single Rewrite</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-[#c9a227]/50 text-center ring-2 ring-[#c9a227]/30">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">5-Pack</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Agent Vault Pro</h3>
      ...
      <section className="py-20 px-6 bg-white/5">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Ready to Write Better MLS Listings?</h2>
          <p className="text-xl text-gray-700 mb-8">Start with a free grade of your listing. See what buyers see. Get actionable feedback in seconds.</p>
