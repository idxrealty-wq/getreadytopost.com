    ...
    <main className="pt-20 min-h-screen relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Why Our AI Is Different</h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Not all AI is created equal. Here is why GetReadyToPost delivers A+ listings every time - and ChatGPT does not.
          </p>
        </div>
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/20 mb-12">
          ...
          <p className="text-gray-300 text-lg mb-4">ChatGPT is amazing for general writing. But real estate listings? That is a different game.</p>
          <p className="text-gray-300 text-lg mb-4">Generic AI does not know MLS rules. It does not understand Fair Housing laws. It cannot pull real neighborhood data. And it definitely does not know what converts browsers into buyers.</p>
          <p className="text-gray-300 text-lg">That is where GetReadyToPost comes in.</p>
        </div>
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/20 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              ...
              <p className="text-gray-300">Our AI is trained on thousands of A+ listings, MLS guidelines, NAR best practices, and Fair Housing compliance rules.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="text-4xl mb-3">📍</div>
              <h3 className="text-xl font-bold text-white mb-2">Real Neighborhood Data</h3>
              <p className="text-gray-300">We pull live data from Google Maps - actual schools, parks, restaurants, golf courses - with real distances. No generic fluff.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="text-4xl mb-3">⚖️</div>
              <h3 className="text-xl font-bold text-white mb-2">MLS and Fair Housing Safe</h3>
              <p className="text-gray-300">Every listing follows Fair Housing laws and MLS compliance rules. No risky language, no violations, no rejections.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="text-4xl mb-3">📈</div>
              <h3 className="text-xl font-bold text-white mb-2">SEO Optimized</h3>
              <p className="text-gray-300">140-160 words, keyword-rich, structured for search engines. Your listings get found by the right buyers.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="text-4xl mb-3">💰</div>
              <h3 className="text-xl font-bold text-white mb-2">Conversion-Focused</h3>
              <p className="text-gray-300">Written to sell. Emotional hooks, benefit-driven language, buyer psychology - not just feature lists.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="text-4xl mb-3">✅</div>
              <h3 className="text-xl font-bold text-white mb-2">Always A+ Quality</h3>
              <p className="text-gray-300">Every listing is graded in 6 categories before delivery. If it is not A+, we rewrite it until it is.</p>
            </div>
          </div>
        </div>
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/20 mb-12">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-gray-300">
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-4 text-center text-[#c9a227]">Yes</td>
                </tr>
                <tr className="border-b border-white/10">
                ...
                <tr className="border-b border-white/10">
                  <td className="py-4">MLS and Fair Housing compliance</td>
                  <td className="py-4 text-center">No</td>
                  <td className="py-4 text-center text-[#c9a227]">Yes</td>
                </tr>
                <tr className="border-b border-white/10">
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-4 text-center">Generic</td>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/20 mb-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">AI Analyzes and Grades</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Copy and Post</h3>
