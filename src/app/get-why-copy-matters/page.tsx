    ...
    <main>
      <section className="bg-gradient-to-br from-[#1a2b4a] to-[#2d4a7c] text-white py-20 pt-32">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">A listing description isn't "extra" â€” it's the copy that follows your property everywhere: MLS, Zillow, Realtor.com, Facebook, email blasts, and your agent website.</p>
        </div>
      </section>
      ...
      <section className="py-10 bg-[#c9a227]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-[#1a2b4a] font-semibold">â€” Newport Beach Real Estate</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-white to-[#faf8f5] p-8 rounded-xl border-l-4 border-[#c9a227] shadow-lg">
              ...
              <p className="text-gray-700">A clear, buyer-friendly description helps shoppers picture the home and decide faster if it's worth a visit.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-[#faf8f5] p-8 rounded-xl border-l-4 border-[#c9a227] shadow-lg">
            ...
            <div className="bg-gradient-to-br from-white to-[#faf8f5] p-8 rounded-xl border-l-4 border-[#c9a227] shadow-lg">
              ...
              <p className="text-gray-700">In a sea of similar homes, the right words highlight what's truly special â€” without hype or exaggeration.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-[#faf8f5] p-8 rounded-xl border-l-4 border-[#c9a227] shadow-lg">
      ...
      <section className="py-12 bg-white border-y border-gray-200">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 font-semibold">â€” Danziger (via NC REALTORSÂ®)</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">âŒ Generic language that blends in with every other listing</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">âŒ Missing key details buyers are actually looking for</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">âŒ Confusing flow or overwhelming "wall of text"</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">âŒ Typos & awkward phrasing that reduce buyer trust</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">âŒ Longer days on market & lower offers</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">âŒ Lost showings to competitors with better copy</p>
            </div>
          </div>
          <div className="mt-12 text-center">
            ...
            <p className="text-[#c9a227] font-semibold">â€” McKissock Learning</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4 p-4 bg-white rounded-lg shadow">
              <span className="text-[#c9a227] text-2xl">âœ“</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-r from-[#1a2b4a] to-[#2d4a7c] text-white p-12 rounded-2xl text-center">
            ...
            <p className="text-xl text-gray-200 mb-8">We rewrite your listing to be <strong>MLS-ready, buyer-focused, and paste-ready</strong> â€” so your property reads like it belongs at the top of the market.</p>
      ...
      <section className="py-8 bg-[#faf8f5]">
        <div className="max-w-4xl mx-auto px-6 text-center text-gray-500 text-sm">
          <p>Sources: Newport Beach Real Estate Cafe â€¢ Hometrack Real Estate Marketing â€¢ NC REALTORSÂ® â€¢ McKissock Learning â€¢ Perry Real Estate College â€¢ Redfin/Grammarly Study</p>
        </div>
      </section>
    </main>
  );
