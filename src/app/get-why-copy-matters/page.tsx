    ...
    <main>
      <section className="bg-gradient-to-br from-[#1a2b4a] to-[#2d4a7c] text-white py-20 pt-32">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">A listing description isn't "extra" — it's the copy that follows your property everywhere: MLS, Zillow, Realtor.com, Facebook, email blasts, and your agent website.</p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-white to-[#faf8f5] p-8 rounded-xl border-l-4 border-[#c9a227] shadow-lg">
              ...
              <p className="text-gray-700">In a sea of similar homes, the right words highlight what's truly special — without hype or exaggeration.</p>
            </div>
            <div className="bg-gradient-to-br from-white to-[#faf8f5] p-8 rounded-xl border-l-4 border-[#c9a227] shadow-lg">
      ...
      <section className="py-20 bg-[#1a2b4a]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">❌ Typos & awkward phrasing that reduce buyer trust</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
              <p className="text-white text-lg">❌ Longer days on market & lower offers</p>
            </div>
            <div className="bg-red-50/10 border border-red-300/30 p-6 rounded-lg">
