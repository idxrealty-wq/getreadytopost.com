    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-slate-700 rounded-lg p-8 border border-amber-500">
          ...
          <p className="text-slate-300 mb-6">Annual verification fee: $10 or 10 credits</p>
          ...
          <div className="space-y-4 mb-6">
            ...
            <label className="flex items-center p-4 bg-slate-600 rounded cursor-pointer hover:bg-slate-500 transition">
              ...
              />
              <div>
                <p className="text-white font-semibold">Pay $10</p>
                <p className="text-slate-400 text-sm">One-time payment via Square</p>
              </div>
            </label>
          </div>
